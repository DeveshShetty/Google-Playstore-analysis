...
# Label(screen4, text="", bg='#174873', width='200', height='50').place(x=0, y=120)
 ...
 Button(screen6, text="Click Here", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white').place(x=1150,y=165)#command=first_option
...
apps? :''', font=("Open Sans", 15, 'bold'), fg='white',bg='black', anchor=W).pack(fill=X,pady=10,padx=20)
 Button(screen6, text="Click Here", bg="black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white').place(x=1150,y=255)#, command=registerd1
 ...
 Button(screen6, text="Click Here", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white').place(x=1150,y=330)#, command=registerd1
 #Label(screen4, text="",width='100', height="3", bg='#174873').pack()
#TODO : Implementation of extra feature free vs paid
 ...
 Button(screen6, text="Click Here", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white').place(x=1150,y=392)#, command=registerd1
 #Label(screen4, text="",width='100', height="3", bg='#174873').pack()
...
#For Rating from 0 to 10
 global screen0, fullname, email, password, repassword, university, gender, tnc 
...
def myfunc():
    print("Hello")
def Help():
    tsmg.showinfo("Alert","Please Contact Suchit Poojari,He is our group leader")

root.title("The PyThon Thugs")
root.geometry("1200x1200")
root.minsize(280,280)
div=Frame(root,bg="Black",borderwidth=7,relief=SUNKEN)
div.pack(side=TOP,fill="x")
label1=Label(div,text="Welcome To Play Store Analysis",fg="White",bg="Black",font="Opensans 19 bold")
label1.pack()
label2=Label(root,text="Please Select Your Choice",fg="White",bg="Black",font="Opensans 19 bold")
label2.pack(pady=20,fill=X)
# For Downloads
b0=Button(root,text="Downloads",fg="White",bg="Black",font="Opensans 10 bold",width=30,command=down)
b0.place(x=200,y=200)
# For Reviews and rating
b1=Button(root,text="Reviews & Ratings",bg="black",fg="white",font="Opensans 10 bold",width=30,command=RanR)
b1.place(x=500,y=200)
# For Sentiments
b2=Button(root,text="Sentiments",bg="black",fg="white",font="Opensans 10 bold",width=30,command=Senti)
b2.place(x=800,y=200)
#TODO : This is for Extra Features which is to be implemented.
b3=Button(root,text="Prediction Model & Other Stastics",bg="black",fg="white",font="Opensans 10 bold",width=30,command=Osts)
b3.place(x=500,y=300)
#TODO: Add New data attach your gui
b4=Button(root,text="Add New Data",bg="black",fg="white",font="Opensans 10 bold",width=30,command=name)
b4.place(x=500,y=400)
label2=Label(text="The Python Thugs",bg="Black",fg="White",font="Opensans 19 bold",padx=19,pady=19,borderwidth=3,relief="groove")
