...
def Osts():
 ...
 Label(screen6, text="Prediction Models & Other Stastics", width='200', height="2", font=("Calibri", 22,'bold'), fg='white', bg='Black').pack()
# Label(screen4, text="", bg='#174873', width='200', height='50').place(x=0, y=120)
 ...
 Label(screen6, text="To know:-", font=("Open Sans", 20, 'bold'), fg='white',bg='Black').pack(fill=X,pady=10)
 ...
 kindly make a prediction and back it with suitable findings. :''', font=("Open Sans", 15, 'bold'), fg='white',bg='black', anchor=W).pack(fill=X,pady=10,padx=20)
 Button(screen6, text="Click Here", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command =fig8).place(x=1150,y=165)#command=first_option
...
apps? :''', font=("Open Sans", 15, 'bold'), fg='white',bg='black', anchor=W).pack(fill=X,pady=10,padx=20)
 Button(screen6, text="Click Here", bg="black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command=s15).place(x=1150,y=255)#, command=registerd1
 
 #Label(screen4, text="",width='100', height="3", bg='#174873').pack()
 
 Label(screen6, text='''17) Does the size of the App influence the number of installs that it gets ? if,yes the
 trend is positive or negative with the increase in the app size. :''', font=("Open Sans", 15, 'bold'), fg='white',bg='Black', anchor=W).pack(fill=X,pady=10,padx=20)
 Button(screen6, text="Click Here", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command=s17).place(x=1150,y=330)#, command=registerd1
 #Label(screen4, text="",width='100', height="3", bg='#174873').pack()
#TODO : Implementation of extra feature free vs paid
 Label(screen6, text='''20) Comparison between Free Vs Paid Application on playstore and conclusion on this :''', font=("Open Sans", 17, 'bold'), fg='white',bg='Black', anchor=W).pack(fill=X,pady=10,padx=20)
 Button(screen6, text="Click Here", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command=s20).place(x=1150,y=392)#, command=registerd1
 #Label(screen4, text="",width='100', height="3", bg='#174873').pack()
 Button(screen6, text="Back", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command=screen6.destroy).place(x=1200,y=600)
 labelkw=Label(screen6,text="The Python Thugs : Prediction & Other",bg="Black",fg="White",font="Opensans 19 bold",padx=19,pady=19,borderwidth=3,relief="groove")
...
def startingScreen(root):
    ...
    datecombo=[]
    for i in range(1,14):
        tk.Label(insertition_frame_1,text=header[i-1],width=11,font=("Calibri",11,'italic'),fg='#483D8B',bg='#8DEEEE').place(x=50,y=40*i)
...
def fig1():
    ...
    createWindow(fig1)
    Label(fig1,text="What is the percentage download in each category on the playstore ? ",width="100",height="2",font=Label1_font,fg='white',bg='#174873').place(x=0,y=0)
    Label(fig1,text="family as the  ",width="100",height="2",font=Label1_font,fg='white',bg='#174873').place(x=1200,y=80)
    b1= Button(fig1, text="BACK",bg="#e79700", width="10", height="1", font=Button1_font,fg='white',command=fig1.destroy).place(x=1200,y=800) 
...
def fig2():
    ...
    b1= Button(fig2, text="BACK",bg="#e79700", width="10", height="1", font=Button1_font,fg='white',command=fig2.destroy ).place(x=1200,y=800) 
...
def fig5():
    ...
    createWindow(fig5)
    Label(fig5,text="What is the download trend category wise over the period for which the data is being made available ?",width="110",height="3",font=Label1_font,fg='white',bg='#174873').place(x=0,y=0)
    b =  Button(fig5, text="back", bg="#e79700", width="10", height="1", font=Button1_font, fg='white',command=fig5.destroy).place(x=1200, y=800)
    ...
    b = Button(fig5 , text = 'SHOW',bg="#e79700", width="10", height="1", font=Button1_font, fg='white',command = lambda:new_plot(TrendDict,variable.get()))
    b.place(x=550, y = 220)
...
def Senti():
 ...
 Label(screen5, text="Sentimentss", width='200', height="2", font=("Calibri", 22,'bold'), fg='white', bg='Black').pack()
# Label(screen4, text="", bg='#174873', width='200', height='50').place(x=0, y=120)
 
 #Label(screen4, text="To know:-", font=("Open Sans", 20, 'bold'), fg='white',bg='#174873', anchor=W).pack()
 Label(screen5, text="To know:-", font=("Open Sans", 20, 'bold'), fg='white',bg='Black').pack(fill=X,pady=10)
 #Label(screen4, text="",width='200', height="3", bg='#174873').pack()
...
the same ratio for positive and negative sentiments. :''', font=("Open Sans", 15, 'bold'), fg='white',bg='black', anchor=W).pack(fill=X,pady=10,padx=20)
 Button(screen5, text="Click Here", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command =s12).place(x=1150,y=165)#command=first_option
 
 #Label(screen4, text="",width='100', height="3", bg='#174873').pack()
 
 Label(screen5, text='''13) Study and find out the relation between the Sentiment-polarity and sentiment-
subjectivity of all the apps. :''', font=("Open Sans", 15, 'bold'), fg='white',bg='black', anchor=W).pack(fill=X,pady=10,padx=20)
 Button(screen5, text="Click Here", bg="black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command =s13).place(x=1150,y=250)#, command=registerd1
 
 #Label(screen4, text="",width='100', height="3", bg='#174873').pack()
 #TODO : Implementation of extra feature Graph
 Label(screen5, text='''19) Graph on sentimental analysis (This is an additional feature) :''', font=("Open Sans", 17, 'bold'), fg='white',bg='Black', anchor=W).pack(fill=X,pady=10,padx=20)
 ...
 #Label(screen4, text="",width='100', height="3", bg='#174873').pack()
 Button(screen5, text="Back", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command=screen5.destroy).place(x=1200,y=600)
 labelkb=Label(screen5,text="The Python Thugs : Sentiments",bg="Black",fg="White",font="Opensans 19 bold",padx=19,pady=19,borderwidth=3,relief="groove")
...
def RanR():
 ...
 Label(screen4, text="Ratings & Reviews", width='200', height="2", font=("Calibri", 22,'bold'), fg='white', bg='Black').pack()
# Label(screen4, text="", bg='#174873', width='200', height='50').place(x=0, y=120)
 
 #Label(screen4, text="To know:-", font=("Open Sans", 20, 'bold'), fg='white',bg='#174873', anchor=W).pack()
 Label(screen4, text="To know:-", font=("Open Sans", 20, 'bold'), fg='white',bg='Black').pack(fill=X,pady=10)
 #Label(screen4, text="",width='200', height="3", bg='#174873').pack()
 
 Label(screen4, text='''4) Which category of apps have managed to get the highest maximum average ratings
 from the users. :''', font=("Open Sans", 15, 'bold'), fg='white',bg='black', anchor=W).pack(fill=X,pady=10,padx=20)
 Button(screen4, text="Click Here", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command =s4).place(x=1150,y=155)#command=first_option
 ...
 co-relation to the number of downloads and the ratings received. :''', font=("Open Sans", 15, 'bold'), fg='white',bg='black', anchor=W).pack(fill=X,pady=10,padx=20)
 Button(screen4, text="Click Here", bg="black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command =fig9).place(x=1150,y=245)#, command=registerd1
 ...
 available for the study. :''', font=("Open Sans", 15, 'bold'), fg='white',bg='Black', anchor=W).pack(fill=X,pady=10,padx=20)
 Button(screen4, text="Click Here", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command =screen9).place(x=1150,y=340)#, command=registerd1
 #Label(screen4, text="",width='100', height="3", bg='#174873').pack()
 Button(screen4, text="Back", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command=screen4.destroy).place(x=1200,y=600)
 labelke=Label(screen4,text="The Python Thugs : Reviews & Ratings",bg="Black",fg="White",font="Opensans 19 bold",padx=19,pady=19,borderwidth=3,relief="groove")
...
# Label(screen1, text="", bg='#174873', width='200', height='50').place(x=0, y=120)
 ...
 Label(screen2, text='''1) What is the percentage download in each category on the playstore. :''', font=("Open Sans", 17, 'bold'), fg='white',bg='Black', anchor=W).pack(fill=X,pady=10,padx=20)
 Button(screen2, text="Click Here", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command =fig1).place(x=1150,y=145)
...
devices ,what is the percentage increase or decrease in the downloads. :''', font=("Open Sans", 15, 'bold'), fg='white',bg='Black', anchor=W).pack(fill=X,pady=10,padx=20)
...
#TODO : Dont know was there in previous gui
 Label(screen2, text='''percentage increase or decrease of apps over the period of years.''', font=("Open Sans", 17, 'bold'), fg='white',bg="black", anchor=W).pack(fill=X,pady=10,padx=20)
...
app will generate over the entire year?. :''', font=("Open Sans", 15, 'bold'), fg='white',bg='black', anchor=W).pack(fill=X,pady=10,padx=20)
 ...
 Label(screen2, text='''2) How many apps have managed to get the following number of downloads
                            ...
                            c) Between 150000 and 500000
                            d) Between 500000 and 5000000
                            e) More than 5000000           :''', font=("Open Sans", 15, 'bold'), fg='white',bg='Black', anchor=W).pack(fill=X,pady=10,padx=20)
...
# Label(screen3, text="",width='200', height="3", bg='#174873').pack()
 ...
 2,50,000 downloads atleast. :''', font=("Open Sans", 15, 'bold'), fg='white',bg='black', anchor=W).pack(fill=X,pady=10,padx=20)
 ...
 being made available. :''', font=("Open Sans", 15, 'bold'), fg='white',bg='black', anchor=W).pack(fill=X,pady=10,padx=20)
...
apps have got over the period of three years. : ''', font=("Open Sans", 15, 'bold'), fg='white',bg='black', anchor=W).pack(fill=X,pady=10,padx=20)
...
category. What is the ratio of downloads for the app that qualifies as teen versus mature17+. :''', font=("Open Sans", 15, 'bold'), fg='white',bg='black', anchor=W).pack(fill=X,pady=10,padx=20)
 #Label(screen3, text="",width='100', height="3", bg='#174873').pack()
...
app used in the study?. :''', font=("Open Sans", 15, 'bold'), fg='white',bg='black', anchor=W).pack(fill=X,pady=10,padx=20)
 ...
 Button(screen3, text="Back", bg="Black", width=10, height=1,font=("Open Sans",13, 'bold'), fg='white',command=screen3.destroy).place(x=1200,y=600)
#For Downloads
def down():
 global screen1
 ...
 Label(screen1, text="Select download category", width='100', height="4", font=("Calibri", 28,'bold'), fg='white', bg='black').pack()
 ...
 labelk=Label(screen1,text="The Python Thugs : Downloads",bg="Black",fg="White",font="Opensans 19 bold",padx=19,pady=19,borderwidth=3,relief="groove")
...
labelb.pack(fill=X)
# For Downloads
b0=Button(root,text="Downloads",fg="White",bg="#00BFFF",font="Opensans 10 bold",width=30,height=3,command=down)
b0.place(x=200,y=200)
# For Reviews and rating
b1=Button(root,text="Reviews & Ratings",bg="#FFD700",fg="white",font="Opensans 10 bold",width=30,height=3,command=RanR)
b1.place(x=500,y=200)
# For Sentiments
b2=Button(root,text="Sentiments",bg="#FF69B4",fg="white",font="Opensans 10 bold",width=30,height=3,command=Senti)
b2.place(x=800,y=200)
#TODO : This is for Extra Features which is to be implemented.
b3=Button(root,text="Prediction Model & Other Stastics",bg="#9370DB",fg="white",font="Opensans 10 bold",width=30,height=3,command=Osts)
b3.place(x=500,y=300)
#TODO: Add New data attach your gui
b4=Button(root,text="Add New Data",bg="#FF4500",fg="white",font="Opensans 10 bold",width=30,height=3,command=new_data)
